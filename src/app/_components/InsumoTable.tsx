...
import { Insumo } from "@/interfaces/Insumo"; // Corrigindo o path de importação se necessário
import { getInsumos } from "@/services/InsumoService"; // Corrigindo o path de importação se necessário

interface InsumoTableProps {
  onRefresh: (callback: () => void) => void;
}

export default function InsumoTable({ onRefresh }: InsumoTableProps) {
